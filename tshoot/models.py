...
class SwitchMain(models.Model):
    switchid = models.IntegerField(primary_key=True)
    name = models.CharField(unique=True, max_length=255)
    ipv4addr = models.CharField(unique=True, max_length=255)
    infrastructure = models.CharField(blank=True, null=True, max_length=50)
    vendor = models.CharField(max_length=255)
    pop = models.CharField(max_length=255, choices=locations, default='Others')
...
class MemberDetails(models.Model):
    ...
    ipv6addr = models.CharField(unique=True, max_length=255, blank=True, null=True)
    connected_ports = ArrayField(base_field=models.CharField(max_length=200))
    switchid = models.ForeignKey(SwitchMain, on_delete=models.CASCADE)
    switch_ip = models.CharField(max_length=255, blank=True, null=True)
    peering_policy = models.CharField(max_length=255)
    channelgroup = models.IntegerField(blank=True, null=True)
    ipv6_enabled = models.BooleanField(default=False)
    speed = ArrayField(base_field=models.IntegerField(blank=True), blank=True, null=True)
